  ...
  return (
    <>
      <div className="p-8 flex flex-col items-center ">
        ...
        <button className="bg-[#4D96A9]  p-4 px-10 text-white font-medium text-[1rem] rounded-[1.825rem] text-center ">
          Download <span>v1.3</span>
        </button>
        <button className="bg-[#855FB1]  p-4 px-10 text-white font-medium text-[1rem] rounded-[1.825rem] text-center mt-4">
          What is it?
        </button>
        ...
        <p className="font-[Red Hat Display]  text-[1.125]  text-[#87879D] text-center">
      ...
      <div className=" bg-[url(./assets/mobile/image-footer.jpg)] bg-cover from-[#4D96A9] bg-blend-overlay">
        <div className="p-8 flex flex-col items-center">
          ...
          <button className="bg-[#855FB1]  p-4 px-10 text-white font-medium text-[1rem] rounded-[1.825rem] text-center ">
            Download <span>v1.3</span>
          </button>
        </div>
      </div>
